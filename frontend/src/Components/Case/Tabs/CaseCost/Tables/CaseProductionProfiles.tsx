        ...
        const newTimeSeriesData: ITimeSeriesTableData[] = [
            {
                ...
                unit: `${projectData?.commonProjectAndRevisionData.physicalUnit === 0 ? "MSm³/yr" : "mill bbls/yr"}`,
            ...
            },
            {
                ...
                unit: `${projectData?.commonProjectAndRevisionData.physicalUnit === 0 ? "GSm³/yr" : "Bscf/yr"}`,
