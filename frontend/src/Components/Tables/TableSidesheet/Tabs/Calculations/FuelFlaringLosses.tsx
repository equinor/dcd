...
const FuelFlaringLosses: React.FC<Props> = ({ developerMode, hasOverride }) => {
    return (
        <Container>
                        ...
                        <FormulaList>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>DynamicWiPower = (WaterRate / (365.25 × FacilitiesAvailability/100 × WaterInjectionCapacity)) × CO2ShareWaterInjectionProfile × (1-CO2OnMaxWaterInjectionProfile)</li>
                                </ul>
                            </li>
                        </FormulaList>
                    </FormulaSection>
            ...
            {developerMode && (
                <Note>
                    <strong>Developer Note:</strong> These calculations are implemented in:
                    <ul>
