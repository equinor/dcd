...
const WellBase: React.FC<Props> = ({ developerMode, hasOverride, wellType, wellCategory }) => {
    return (
        <Container>
            <Section>
                <Typography variant="h6">{wellType} Well Cost Calculation</Typography>
                <Typography variant="body1" style={{ marginTop: 12, marginBottom: 24 }}>
                    The {wellType.toLowerCase()} well cost (in MUSD) is calculated based on the drilling schedule and well cost:
                </Typography>

                <Formula>
                    <MainFormula>
                        {wellType} Well Cost = Number of Wells × Well Cost
                    </MainFormula>
                    ...
                    <FormulaSection>
                        ...
                        <FormulaList>
                            ...
                            <li>Only includes wells categorized as {wellCategory}</li>
                        </FormulaList>
                    </FormulaSection>
                    ...
                    <FormulaSection>
                        ...
                        <FormulaList>
                            <li>Filter WellProjectWells for {wellCategory} category</li>
                            <li>For each well with a drilling schedule:
                                <ul>
            ...
            {developerMode && (
                <Note>
                    <strong>Developer Note:</strong> This calculation is implemented in:
                    <ul>
                        <li>backend/api/Features/Cases/Recalculation/Types/WellCostProfile/WellProjectWellCostProfileService.cs</li>
                        <li>Method: RunCalculation() with WellCategory.{wellCategory}</li>
