...
const EnvironmentalImpactTab = ({ rowData, dg4Year }: Props) => {
    ...
    const getEnvironmentalScore = () => {
        ...
        if (intensity > 50) score -= 30
        else if (intensity > 30) score -= 20
        else if (intensity > 10) score -= 10
        
        // Penalize for increasing trend
        if (trend > 10) score -= 30
        else if (trend > 5) score -= 20
        ...
        <Container>
            ...
            <Section>
                ...
                <MetricCard>
                    ...
                    <MetricValue>
                        {calculateCarbonIntensity()} tCO2e/unit
                    </MetricValue>
                    <MetricDescription>
