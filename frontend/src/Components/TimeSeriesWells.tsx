...
const TimeSeriesWells = ({
    ...
    return (
        <WrapperColumn>
            <DataTableWell
                columns={columnsFromTableYears}
                dG4Year={dG4Year.toString()}
                wellsTimeSeries={[]}
                timeSeriesData={timeSeriesData}
                expDrillingSchedules={expDrillingSchedules}
                devDrillingSchedules={devDrillingSchedules}
            />
        </WrapperColumn>
    )
}
