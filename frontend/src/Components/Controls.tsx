...
import { Icon, Typography, Button, Progress, Input } from "@equinor/eds-core-react"
import { save, edit, keyboard_tab, more_vertical, arrow_back } from "@equinor/eds-icons"
...
const Controls = () => {
    ...
    const { project, setProject, projectEdited, setProjectEdited } = useProjectContext()
    const { projectCase, setProjectCase, renameProjectCase, setRenameProjectCase, projectCaseEdited, setProjectCaseEdited } = useCaseContext()
            ...
            <Grid item xs container spacing={1} alignItems="center" justifyContent="flex-end">
                ...
                <Grid item>
                    <Button onClick={handleEdit}>
                        {isSaving 
                        ? <Progress.Dots />
                        : <><Icon data={editMode ? save : edit} /> {editMode ? "Save" : "Edit"}</>
                        }
                    </Button>
                </Grid>
                <Grid item>
