...
export const CreateAsset = async (assetType: string, caseId: string, projectId: string) => {
    ...
    if (assetType === AssetType.DrainageStrategy) {
        ...
        assetId = newProject?.cases.find((o) => o.id === caseId)?.links?.drainageStrategyLink
        ...
        assetId = newProject?.cases.find((o) => o.id === caseId)?.links?.explorationLink
        ...
        assetId = newProject?.cases.find((o) => o.id === caseId)?.links?.wellProjectLink
        ...
        assetId = newProject?.cases.find((o) => o.id === caseId)?.links?.surfLink
        ...
        assetId = newProject?.cases.find((o) => o.id === caseId)?.links?.topsideLink
        ...
        assetId = newProject?.cases.find((o) => o.id === caseId)?.links?.substructureLink
        ...
        assetId = newProject?.cases.find((o) => o.id === caseId)?.links?.transportLink
    }
