...
public static class TestDataGenerator
{
    ...
    public static DrainageStrategyDto Case2DrainageStrategy()
    {
        return new DrainageStrategyDto
        {
            ...
            {
                StartYear = 2030,
                Values = new[] { 22.0460776e9, 23.0459552635016671e9,
            ...
            {
                StartYear = 2030,
                Values = new[] { 25.438e6, 65.436837105529155e6,
            ...
            {
                StartYear = 2030,
                Values = new[] { 654.045534094613436e9,
            ...
            {
                StartYear = 2029,
                Values = new[] { 85.009e6, 7521.00202727509188372e6,
