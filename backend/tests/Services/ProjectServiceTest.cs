...
public class ProjectServiceTest : IDisposable
{
    ...
    public void GetProject()
    {
        ...
        {
            var projectFromGetProjectService = projectService.GetProjectWithBaggage(project.Id);
    ...
    public void GetDoesNotExist()
    {
        var loggerFactory = new LoggerFactory();
        ProjectService projectService = new ProjectService(fixture.context, loggerFactory, _serviceProvider);
        Assert.Throws<NotFoundInDBException>(() => projectService.GetProjectWithBaggage(new Guid()));
    }
}
