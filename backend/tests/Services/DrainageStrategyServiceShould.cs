...
public class DrainageStrategyServiceShould : IDisposable
{
    ...
    public void CreateNewDrainageStrategy()
    {
        ...
        // Act
        var projectResult =
            drainageStrategyService.CreateDrainageStrategy(
                DrainageStrategyDtoAdapter.Convert(expectedStrategy, project.PhysicalUnit), caseId);
    ...
    public void ThrowNotFoundInDatabaseExceptionWhenCreatingDrainageStrategyWithBadCaseId()
    {
        ...
        Assert.Throws<NotFoundInDBException>(() =>
            drainageStrategyService.CreateDrainageStrategy(
                DrainageStrategyDtoAdapter.Convert(expectedStrategy, project.PhysicalUnit), new Guid()));
    }
