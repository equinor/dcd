...
public class TransportServiceShould
{
    ...
    public void ThrowNotInDatabaseExceptionWhenCreatingTransportWithBadProjectId()
    {
        ...
        Assert.Throws<NotFoundInDBException>(() =>
            transportService.CreateTransport(TransportDtoAdapter.Convert(expectedTransport), caseId));
    }
    ...
    public void ThrowNotFoundInDatabaseExceptionWhenCreatingTransportWithBadCaseId()
    {
        ...
        // Act, assert
        Assert.Throws<NotFoundInDBException>(() =>
            transportService.CreateTransport(TransportDtoAdapter.Convert(expectedTransport), new Guid()));
    }
