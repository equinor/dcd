    ...
    public async Task<Project> GetProject(Guid projectId)
    {
        if (_context.Projects != null)
        {
            ...
            var project = await _context.Projects!
                ...
                .Include(p => p.Cases)!.ThenInclude(c => c.TotalOtherStudiesOverride)
                ...
                .Include(p => p.Cases)!.ThenInclude(c => c.HistoricCostCostProfileOverride)
                .Include(p => p.Cases)!.ThenInclude(c => c.AdditionalOPEXCostProfile)
                .Include(p => p.Cases)!.ThenInclude(c => c.AdditionalOPEXCostProfileOverride)
