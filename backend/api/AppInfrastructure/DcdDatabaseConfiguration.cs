...
public static class DcdDatabaseConfiguration
{
    ...
    [
        ...
        ("NetSalesGas", ProfileTypes.NetSalesGas, false, "DrainageStrategy", "DrainageStrategies"),
        ("NetSalesGasOverride", ProfileTypes.NetSalesGasOverride, true, "DrainageStrategy", "DrainageStrategies"),
        ...
        ("ProductionProfileGas", ProfileTypes.ProductionProfileGas, false, "DrainageStrategy", "DrainageStrategies"),
        ("AdditionalProductionProfileGas", ProfileTypes.AdditionalProductionProfileGas, false, "DrainageStrategy", "DrainageStrategies"),
        ("ProductionProfileWater", ProfileTypes.ProductionProfileWater, false, "DrainageStrategy", "DrainageStrategies"),
        ...
        ("DeferredGasProduction", ProfileTypes.DeferredGasProduction, false, "DrainageStrategy", "DrainageStrategies"),
    ];
}
