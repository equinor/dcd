...
public static class SubstructureAdapter
{
    ...
    private static SubstructureCessationCostProfile? Convert(
        SubstructureCessationCostProfileDto? substructureCessationCostProfileDto, Substructure substructure)
    {
        ...
        var substructureCessationCostProfile = new SubstructureCessationCostProfile
        {
            Substructure = substructure,
