...
public static class TransportAdapter
{
    ...
    private static TransportCessationCostProfile? Convert(
        TransportCessationCostProfileDto? transportCessationCostProfileDto, Transport transport)
    {
        ...
        var transportCessationCostProfile = new TransportCessationCostProfile
        {
