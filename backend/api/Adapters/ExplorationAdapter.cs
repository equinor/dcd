...
public static class ExplorationAdapter
{
    public static Exploration Convert(ExplorationDto explorationDto)
    {
        ...
        exploration.SeismicAcquisitionAndProcessing =
            Convert(explorationDto.SeismicAcquisitionAndProcessing, exploration);
    ...
    private static SeismicAcquisitionAndProcessing Convert(
        SeismicAcquisitionAndProcessingDto? seismicAcquisitionAndProcessing, Exploration exploration)
    {
