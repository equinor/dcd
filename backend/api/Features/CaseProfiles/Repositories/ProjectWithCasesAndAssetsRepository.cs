...
public interface IProjectWithCasesAndAssetsRepository
{
    Task<Project> GetProjectWithCasesAndAssets(Guid projectPk);
}

public class ProjectWithCasesAndAssetsRepository(DcdDbContext context) : IProjectWithCasesAndAssetsRepository
{
