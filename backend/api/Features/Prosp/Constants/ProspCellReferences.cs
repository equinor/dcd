namespace api.Features.Prosp.Constants;
...
public static class ProspCellReferences
{
    public static class Surf
    {
        ...
        public const string ArtificialLiftInt = "E48";
        public const string RiserCount = "K36";
        public const string TemplateCount = "K32";
        public const string ProducerCount = "E45";
        public const string WaterInjectorCount = "E46";
    ...
    public static class TopSide
    {
        ...
        public const string FlaredGas = "K93";
        public const string OilCapacity = "E27";
        public const string GasCapacity = "E29";
        public const string ProducerCount = "E38";
        public const string GasInjectorCount = "E40";
        public const string WaterInjectorCount = "E39";
        public const string Co2ShareOilProfile = "J99";
        public const string Co2ShareGasProfile = "J100";
        public const string Co2ShareWaterInjectionProfile = "J101";
        public const string Co2OnMaxOilProfile = "L99";
        public const string Co2OnMaxGasProfile = "L100";
        public const string Co2OnMaxWaterInjectionProfile = "L101";
