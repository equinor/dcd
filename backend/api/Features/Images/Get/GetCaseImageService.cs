...
public class GetCaseImageService(DcdDbContext context, BlobServiceClient blobServiceClient)
{
    ...
    private async Task<string> GetImageContent(CaseImage image)
    {
    ...
    private static ImageDto MapToDto(CaseImage imageEntity, string base64EncodedImage)
    {
        return new ImageDto
        {
            ...
            ProjectId = imageEntity.Case.ProjectId,
