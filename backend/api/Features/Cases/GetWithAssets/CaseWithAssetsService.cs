    ...
    IConversionMapperService conversionMapperService)
{
    public async Task<CaseWithAssetsDto> GetCaseWithAssetsNoTracking(Guid projectId, Guid caseId)
    {
        ...
        return new CaseWithAssetsDto
        {
            ...
            Co2EmissionsOverride = ConversionMapToDto<Co2EmissionsOverride, TimeSeriesCostOverrideDto>(drainageStrategy.Co2EmissionsOverride, drainageStrategy.Co2EmissionsOverride?.Id, project.PhysicalUnit),
            ...
            ImportedElectricity = ConversionMapToDto<ImportedElectricity, TimeSeriesCostDto>(drainageStrategy.ImportedElectricity, drainageStrategy.ImportedElectricity?.Id, project.PhysicalUnit),
            ImportedElectricityOverride = ConversionMapToDto<ImportedElectricityOverride, TimeSeriesCostOverrideDto>(drainageStrategy.ImportedElectricityOverride, drainageStrategy.ImportedElectricityOverride?.Id, project.PhysicalUnit),
