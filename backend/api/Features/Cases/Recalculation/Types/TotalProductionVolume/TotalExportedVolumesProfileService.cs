...
public static class TotalExportedVolumesProfileService
{
    public static void RunCalculation(Case caseItem)
    {
        ...
        nglProduction.Values = nglProduction.Values.Select(v => v * 1.9).ToArray();
        ...
        caseItem.CreateProfileIfNotExists(ProfileTypes.TotalExportedVolumes).Values = totalExportedVolumes.Values;
    }
