...
public static class ProjectDuplicator
{
    ...
    private static Case DuplicateCase(Case existingCaseItem, Guid projectId, Guid caseId, Dictionary<Guid, Guid>? wellIdMapping, bool linkToOriginalCase)
    {
        ...
        var newCase = new Case
        {
            ...
            Co2EmissionsFromFlaredGas = existingCaseItem.Co2EmissionsFromFlaredGas,
            Co2Vented = existingCaseItem.Co2Vented,
            DailyEmissionFromDrillingRig = existingCaseItem.DailyEmissionFromDrillingRig,
            AverageDevelopmentDrillingDays = existingCaseItem.AverageDevelopmentDrillingDays,
