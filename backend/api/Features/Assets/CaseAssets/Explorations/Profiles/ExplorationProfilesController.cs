...
namespace api.Features.Assets.CaseAssets.Explorations.Profiles;

[Route("projects/{projectId}/cases/{caseId}/explorations")]
[AuthorizeActionType(ActionType.Edit)]
public class ExplorationProfilesController(ExplorationTimeSeriesService explorationTimeSeriesService) : ControllerBase
{
