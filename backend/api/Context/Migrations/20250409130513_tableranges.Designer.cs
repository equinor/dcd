...
namespace api.Migrations
{
    ...
    [Migration("20250409130513_tableranges")]
    partial class tableranges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.CampaignWell", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("WellId", "CampaignId")
                        .IsUnique();

                    b.ToTable("CampaignWells");
                });
            ...
            modelBuilder.Entity("api.Models.Case", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("CaseCostYears")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.PrimitiveCollection<string>("Co2EmissionsYears")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.PrimitiveCollection<string>("DrillingScheduleYears")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<double>("InitialYearsWithoutWellInterventionCost")
                        .HasColumnType("float");
                    ...
                    b.PrimitiveCollection<string>("ProductionProfilesYears")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("api.Models.Project", b =>
                {
                    ...
                    b.HasOne("api.Models.Case", "ReferenceCase")
                        .WithMany()
                        .HasForeignKey("ReferenceCaseId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("OriginalProject");

                    b.Navigation("ReferenceCase");
                });
