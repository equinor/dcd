...
namespace api.Migrations
{
    ...
    [Migration("20250203163634_RenameWellProjectWellToDevelopmentWell")]
    partial class RenameWellProjectWellToDevelopmentWell
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.Case", b =>
                {
                    ...
                    b.HasIndex("SubstructureId");

                    b.HasIndex("SurfId");

                    b.HasIndex("TopsideId");
            ...
            modelBuilder.Entity("api.Models.Case", b =>
                {
                    b.HasOne("api.Models.DrainageStrategy", "DrainageStrategy")
                        .WithMany()
                        .HasForeignKey("DrainageStrategyId")
                    ...
                    b.HasOne("api.Models.Substructure", "Substructure")
                        .WithMany()
                        .HasForeignKey("SubstructureId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("api.Models.Surf", "Surf")
                        .WithMany()
                        .HasForeignKey("SurfId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("api.Models.Topside", "Topside")
                        .WithMany()
                        .HasForeignKey("TopsideId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
